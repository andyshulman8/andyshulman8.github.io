...
export const allCaseStudies: CaseStudyData[] = [
  {
    ...
    allImpact: [
      { metric: "2-3 hrs → 10m", label: "Resolution Time" },
    ...
    stops: [
      {
        ...
        phase: "Empathize",
        content:
          "I led recurring user research sessions, conducting Zoom interviews and analyzing users' current workflows to understand where our product was failing. I discovered three critical gaps:",
        quote:
        ...
        numberedFeatures: [
          {
            ...
            description:
              "Critical troubleshooting moments are only more stressful with siloed apps; users were forced to juggle various tools and processes.",
          },
          {
            title: "Inefficient Filtering",
            description:
              "Competitors offered advanced search, so our users asked: 'Why is LM Logs search so small? Where is my recent history?'",
          },
          {
            title: "Raw Data Overload",
            description:
              "Without diverse and integrated visualizations, the benefit of LM Logs was buried.",
          },
        ],
        callout:
          "Our customers weren't the only ones suffering, LogicMonitor itself avoided using LM Logs, forcing us to spend on a competitor.",
      },
      {
        ...
        phase: "Ideate",
        content:
          "LogicMonitor allows its users to access a plethora of tools to help monitor their infrastructure. I designed seamless workflows connecting logs across the platform so engineers like John at RaySearch didn't have to context switch in critical moments: reducing tool sprawl and creating a single pane of glass.",
        features: [
          {
            title: "Added logs widgets capabilities to dashboards",
            description: "",
          },
          {
            title: "Made logs visible alongside device and service data",
            description: "",
          },
          {
            title: "Display anomalous logs available within alert",
            description: "",
          },
        ],
        images: [
      ...
      },
      {
        ...
        phase: "Test",
        content:
          "Through close collaboration across global teams, I helped transform LM Logs from a niche add-on to a flagship product that LogicMonitor itself relied on. \n\nRaySearch develops pioneering software used by cancer clinics worldwide to plan and deliver radiation therapy safely and effectively. By simplifying complexity and integrating logs seamlessly into the platform, I helped ensure that cancer treatment software at RaySearch Labs runs reliably: ultimately supporting better patient care.",
        quote:
          "We had users complaining that there was a licensing error. Using LogicMonitor's platform, including LM Logs, we were able to trace the issue and do a stop service on a server way down the line. The process took about 10 minutes versus the two to three hours it would have taken without the visibility.",
        quoteAuthor:
          "John Burriss, Senior IT Solutions Engineer at RaySearch Labs",
        impact: {
  ...
  },
  {
    ...
    allImpact: [
      { metric: "30% reduction", label: "in alert fatigue" },
      // { metric: "1000+", label: "Customers Served" },
    ...
    stops: [
      {
        ...
        phase: "Empathize",
        content:
          "Through interviews, testing, and journey mapping with a recurring loop of 30+ LogicMonitor customers, three key challenges emerged:",
        quote:
        ...
        features: [
          {
            title: "Alert Fatigue",
            description:
              "Thousands of daily alerts buried critical issues in noise",
          },
          {
            title: "Slow Troubleshooting",
            description:
              "Engineers spent hours diagnosing incidents, even repeated ones",
          },
          {
            title: "Reactive Monitoring",
            description: "Teams discovered problems only after they escalated",
          },
        ],
        images: [
      ...
      },
      {
        ...
        numberedFeatures: [
          {
            title:
              "Make deep investigation across LM's tools seamless and intuitive",
            description: "",
          },
          {
            title: "Provide a clear, one-click starting point for triage",
            description: "",
          },
          {
            title: "No hunting for value, value is served to you",
            description: "",
          },
        ],
        callout:
          'This work became the foundation for "Edwin AI" and positioned LogicMonitor for their [2025 partnership](https://www.logicmonitor.com/partners/ibm) with IBM and Red Hat on AI-driven, self-healing infrastructure.',
      },
      {
        station_name: "Impact",
        phase: "Test",
        content:
          "Schneider Electric helps power some of the largest digital and energy ecosystems on the planet including Google and Amazon. My troubleshooting and LM Logs improvements freed up Schneider Electric's time, energy, and infrastructure resources meaning fewer redundant systems running, less compute power wasted, and faster response to issues that can impact energy systems worldwide. ",
        quote:
  ...
  },
  {
    ...
    allImpact: [
      {
        metric: "17,000+ students",
        label: "Protected with secure access controls",
      },
      {
        metric: "3x integration support",
        label:
          "Expanded from a few native integrations to various cloud + on-prem options",
      },
      {
        metric: "10x faster onboarding",
        label: "Via natural language search and templates",
      },
    ],
    stops: [
      {
        ...
        phase: "Empathize",
        content:
          "Without proper access controls, one misconfigured permission could expose thousands of student health records or financial aid data: a career-ending mistake for someone like Mike and devastating for students and professors. Compliance management was complex, error-prone, and high-stakes. \n\n I led recurring user research sessions, conducting interviews and analyzing workflows to understand where our product was failing.",
        quote:
          "We had to manage logs from campus safety systems, VoIP devices, and servers, all with different requirements. Tech changes fast. Our tools needed to keep up.",
        quoteAuthor:
          "Mike Dieter, Senior Systems Engineer at Loyola University of Maryland",
        features: [
          {
            title: "Access Control Limitations",
            description:
              "Existing tools lacked granular permissions, creating potential exposure of sensitive student and staff data",
          },
          {
            title: "Log Collection Complexity",
            description:
              "Collecting logs from diverse systems (VoIP, security, academic networks) was slow and error-prone",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        features: [
          ...
          {
            title: "Step-by-step forms with inline documentation",
            description: "",
          },
      ...
      },
      {
        ...
        phase: "Test",
        content:
          "By turning complex compliance requirements into intuitive workflows with Partitions, templates, and Natural Language Search, I helped Loyola University protect data and operate with confidence as privacy laws and log types evolve. In addition to strengthening customer trust, my work also reinforced LogicMonitor’s credibility in regulated enterprise environments.",
        quote:
          "For the University, IT infrastructure is evolving far faster in 3-5 years now than it did in the previous 5 years. What we really like about LogicMonitor is that it gives us the flexibility to adapt to those changes as it occurs.",
        quoteAuthor:
          "Mike Dieter, Senior Systems Engineer at Loyola University of Maryland",
        impact: {
          metric1: "90 seconds",
  ...
  },
  {
    ...
    stops: [
      ...
      },
      {
        ...
        phase: "Define",
        content:
          "Align's network of dental professionals ultimately needed a stronger village, a stronger community. I taught the team to reframe problems our interviewees faced. The team built their first design frames, learning to focus on needs rather than solutions.",
        quote:
      ...
      },
      {
        ...
        phase: "Ideate",
        content:
          "After reframing problems our interviewees faced, I ran workshops where we brainstormed what would be effective to address the targets' needs, and how to make those things happen. I leveraged time constricted sessions with various constraints, starting with a basic brainstorm around how we may achieve the game-changers each team landed on.",
        quote:
          "Building off of our group's ideas enabled synergy & ability to develop better concepts.",
      ...
      },
      {
        ...
        phase: "Prototype",
        content:
          "Before building out our prototypes, I identified a question or two that we aimed to answer by testing each prototype. With a key question in mind, I brought each concept to the team to start brainstorming how we could answer those questions. \n\nWe tested across media: built physical prototypes, surveys, a Facebook page, and even a (popular) podcast episode. After instructing the team on user testing, I sent the teams off to get results with real doctors who use Align. ",
        quote:
      ...
      },
      {
        ...
        phase: "Test",
        content:
          "What started as a one-off training became a movement: a culture shift that empowered professionals to think creatively and act empathetically. By scaling design thinking internally, Align accelerated its ability to identify and test new service ideas faster and with greater team buy-in.",
        impact: {
        ...
        quote:
          "We have made great progress on the design thinking front and working on a big program to reimagine billing - kicking the improvements we made into the next gear.",
        quoteAuthor:
          "Volker Probst, VP of Customer Success at Align Technology",
  ...
  },
  {
    ...
    overview:
      "I worked mostly independently with periodic input from exhibit developers. I synthesized research, strategy, and systems thinking into a shared creative direction for the SESI Lab team, creating a framework that would inspire every visitor to see themselves as capable of changing the future.",
    allImpact: [
      {
        metric: ">2000 teachers",
        label:
          "have learned new approaches to science through the new museum since opening in 2022",
      },
      {
    ...
    stops: [
        ...
        features: [
          {
            ...
            description:
              " in underserved communities facing educational barriers",
          },
          {
            title: "Empower citizens",
            description: "to see themselves as capable of shaping their future",
          },
          {
            title: "Address systemic barriers",
            description:
              'that leave people feeling, "I\'m just one person" or, "others are smarter"',
          },
        ],
      },
      {
        ...
        phase: "Define",
        content:
          "After learning about and empathizing with our stakeholders, I iterated to define the vision. I revised it from a generic 'cool future' to something timeless: 'A world in which every Brazilian has confidence in their ability to change the future.' Confidence is tied to workforce participation, entrepreneurship, and civic engagement.",
      },
      {
      ...
      },
      {
        ...
        phase: "Test",
        content:
          "I established key metrics and identified the optimal method of evaluation for the museum. I also conducted a pre-mortem analysis to identify potential risks and provided actionable next steps. Today the museum is thriving, having served 100,000+ visitors since opening in 2022.",
        quote:
    ...
    stops: [
      {
        ...
        phase: "Empathize",
        content:
          "Working across two health-focused product lines revealed overlapping challenges:",
        quote:
          "I stopped going to restaurants because I couldn't follow conversations.",
        quoteAuthor: "Hearing aid user",
        features: [
          {
            title: "Expert access",
            description:
              "Audiologists and researchers are critical but often overextended.",
          },
          {
            title: "Unclear interaction flows",
            description:
              "Users were left too confused or embarrassed to keep trying",
          },
          {
            title: "Constant change",
            description:
              "Business priorities in health shift often, making alignment difficult without a shared source of truth.",
          },
        ],
      },
      {
        ...
        phase: "Define",
        content:
          "To streamline collaboration across the Bose Health division, I created a centralized research tracker that improved visibility across design, research, and engineering. The tool included categorized research questions, clear ownership, and criteria for when to consult experts.",
        features: [
          {
        ...
        features: [
          {
            ...
            description:
              'What specific action should users take? (e.g., "Set sleep reminder 30 min before bed")',
          },
          {
            title: "Make it Easier (reduce friction)",
            description:
              "Reduce friction: pre-fill times, minimize taps, smart defaults",
          },
          {
            title: "Projected Effectiveness.",
            description:
              "Likelihood of habit formation based on barrier analysis",
          },
        ],
      },
      {
        ...
        phase: "Test",
        content:
          "Not every product survives, but aligned teams navigate uncertainty better. When Bose exited health, the teams I worked with had shared language for user needs, research infrastructure that reduced rework, and frameworks that some took to their next roles.",
        impact: {
          metric1: "30+% reduction",
