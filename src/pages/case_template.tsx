...
const WindowMedia = ({
  ...
  src: string | { src: string; type: "image" | "video" };
}) => {
        ...
        {showOverview ? (
          <div className="max-w-5xl mx-auto px-6 py-12">
            ...
            <div className="w-full lg:w-auto">
              ...
              <div className="flex flex-wrap items-start gap-4">
                ...
                <div className="w-full sm:w-auto mb-[24px]">
                  <ExpressTicketCTA onClick={startJourneyAtBeginning} />
                </div>
              </div>
            </div>
                ...
                <div className="relative md:col-span-2 space-y-6">
                  ...
                  >
                    ...
                    <CarouselControls
                      ...
                      onPrev={() =>
                        setPeekIndex(
                          (peekIndex - 1 + caseStudyData.peeks.length) %
                            caseStudyData.peeks.length,
                        )
                      }
                      onNext={() =>
                        setPeekIndex(
              ...
              caseStudyData.stops[caseStudyData.stops.length - 1]?.quote && (
                ...
                >
                  <div className="grid md:grid-cols-1 gap-8">
                    <div className="relative bg-white/5 border border-white/10 p-10 rounded-2xl overflow-hidden group transition-all hover:bg-white/[0.07]">
                      <div
                      ...
                      <div className="relative z-10 flex flex-col h-full">
                        <p className="text-white/80 italic mb-8 leading-relaxed flex-grow">
                          {
                            caseStudyData.stops[caseStudyData.stops.length - 1]
                              .quote
                          }
                        </p>
                        ...
                        >
                          {(() => {
                            const authorString =
                              caseStudyData.stops[
                                caseStudyData.stops.length - 1
                              ].quoteAuthor || "";
                            const name =
                              authorString.split(",")[0]?.trim() || "";
            ...
            <div className="text-center mt-16  relative">
              ...
              <button
                ...
                className={`px-8 py-4 rounded-full font-bold text-black text-lg hover:scale-105 ${"relative mt-12 mb-1 px-8 py-4 text-lg"}`}
                style={{
          ...
          <div className="max-w-5xl mx-auto px-6 py-12">
            ...
            {hasImages && (
              <div className="relative max-w-4xl mx-auto mb-8">
                ...
                >
                  ...
                  <CarouselControls
                    length={
                      caseStudyData.stops[currentStop].images?.length || 0
                    }
                    activeIndex={stopCarouselIndex}
                    onPrev={() => {
                      const len =
                        caseStudyData.stops[currentStop].images!.length;
            ...
            <div className="prose prose-invert max-w-none">
              ...
              {stop.callout && (
                <CalloutBox>{renderMarkdownLinks(stop.callout)}</CalloutBox>
              )}
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between items-center gap-3 pt-8 border-t border-white/10">
              <button
                ...
                style={{
                  ...
                  ...(isPrevHovered &&
                    currentStop > 0 && {
                      backgroundColor: PREV_BUTTON_HOVER_BG,
                    }),
                }}
