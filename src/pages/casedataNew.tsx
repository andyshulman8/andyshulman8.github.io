...
export const allCaseStudies: CaseStudyData[] = [
  {
    ...
    background:
      "Before LogicMonitor had acquired (and properly integrated) a logs product, users were forced to jump between disconnected tools during critical moments. RaySearch Labs' Senior IT Solutions Engineer spent 50-60% of his time manually reviewing logs.",
    overview:
    ...
    stops: [
      {
        ...
        phase: "Empathize",
        content:
          "I led recurring user research sessions, conducting Zoom interviews and analyzing users' current workflows to understand where our product was failing. Working with customers like RaySearch Labs (who develop pioneering cancer treatment software), I discovered three critical gaps.",
        quote:
      ...
      },
      {
        ...
        phase: "Prototype",
        content:
          "I transformed raw log data into actionable insights through visual analytics. Designed multiple graph types, advanced query operators (count, avg, sum, min, max), and dashboard integration. RaySearch could have a dashboard on a TV in their office—a spike in errors would be obvious and immediately easy to assess.",
      },
      {
        station_name: "Launch & Impact",
        phase: "Test",
        content:
          "Through close collaboration across global teams, I helped transform LM Logs from a niche add-on to a flagship product that LogicMonitor itself relied on. LogicMonitor did not use its own logs product until my team and I improved and integrated it enough to achieve all its needs.",
        quote:
