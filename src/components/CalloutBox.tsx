...
export default function CalloutBox({ children }: CalloutBoxProps) {
  return (
    <div className="rounded-lg p-4 mb-6 border border-white/10 bg-black/50 flex items-start gap-4">
      <div className="flex-shrink-0 text-white/80">
        <svg aria-hidden="true" width="28" height="28" viewBox="0 0 448 512" fill="currentColor">
